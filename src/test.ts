  ...
  switch (shape) {
    case "Circle":
      for (let i = 1; i <= 14; i++) {
        ...
        cards.push(new Card(`${i}-circle`, "Circle", "market", i));
      }
      break;
    case "Triangle":
      for (let i = 1; i <= 14; i++) {
        ...
        cards.push(new Card(`${i}-tri`, "Triangle", "market", i));
      }
      break;
    case "Cross":
      for (let i = 1; i <= 14; i++) {
        ...
        cards.push(new Card(`${i}-cross`, "Cross", "market", i));
      }
      break;
    case "Square":
      for (let i = 1; i <= 14; i++) {
        ...
        cards.push(new Card(`${i}-square`, "Square", "market", i));
      }
      break;
    case "Star":
      for (let i = 1; i <= 14; i++) {
        ...
        cards.push(new Card(`${i}-star`, "Star", "market", i));
      }
      break;
    default:
      for (let i = 1; i <= 5; i++) {
        cards.push(new Card(`${i}-whot`, "Whot", "market", 20));
      }
  }
}

// const players: Player[] = [new Player(1, "Umar", []), new Player(2, "AI", [])];
